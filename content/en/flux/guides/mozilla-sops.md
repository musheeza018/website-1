...
When using Azure Key Vault you need to authenticate kustomize-controller either with [aad-pod-identity](../installation/bootstrap/azure.md#aad-pod-identity)
